package com.lambdami.hellu.processdata.charts;
...
public class CreateDatasets {
    ...
    static public int[][] createArrayDataYear(ArrayList<CitedPublication> publications, String TYPE ) {
        ...
        List<Publication> choice = new ArrayList<Publication>();
    ...
    private static void fillDataArray(List<Publication> choice, int[][] result ) {
