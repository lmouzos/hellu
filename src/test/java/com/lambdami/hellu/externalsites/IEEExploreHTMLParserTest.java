...
class IEEExploreHTMLParserTest {

    private final HTMLParser underTest = new IEEExploreHTMLParser();

    @Test
    void parseAuthors() throws IOException {
        Document content = Jsoup.parse(HtmlUtils.getContent("/html/ieeexplore.html"));
